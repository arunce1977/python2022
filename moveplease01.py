...
def main():
    ...
    shutil.move('test.test', 'ceph_storage/')  # try moving the file raynor.obj into ceph_storage/ dir
    ...
    shutil.move('test.test', 'ceph_storage/' + xname)  # moving kerrigan.obj into
